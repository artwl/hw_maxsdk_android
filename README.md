...
本文档是Android版变现SDK，当前版本 `V9.2`， <b>  建议接SDK，就接最新的版本 </B>

## 下载地址

SDK 下载地址：[v.9.2](https://github.com/artwl/hwsdk_android/releases/tag/V9.2)
...
- **9.2 新特性 (9.2 - 2022年4月7日)**
  - 1.这个版本主要是修改了banner由两套聚合控制，可以任意切换
