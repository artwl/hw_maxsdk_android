...
本文档是Android版变现SDK，当前版本 `V9.8.78`， <b>  建议接SDK，就接最新的版本 </B>

## 下载地址

SDK 下载地址：[v.9.8.78](https://github.com/artwl/hw_maxsdk_android/releases)
...
- **9.8.78 新特性 (9.8.78 - 2026年9月16日)**
  - 1.优化SDK内部逻辑
  - 2.新增打点
  - 3.更新第三方库版本
    
- **9.8.68 新特性 (9.8.68 - 2026年6月8日)**
  - 1.优化SDK内部逻辑
  - 2.将 minSdk 版本设置为 24
  - 3.更新第三方库版本
